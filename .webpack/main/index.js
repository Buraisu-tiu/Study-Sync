...
const createWindow = () => {
    const mainWindow = new electron_1.BrowserWindow({
        ...
        width: 1200,
        webPreferences: {
            preload: 'C:\\Users\\b1squ\\coding\\Study\\Study-Sync\\.webpack\\renderer\\main_window\\preload.js',
        },
    });
    // Load the main app
    ...
    // Set a custom Content Security Policy to allow connections to localhost:3001 and unsafe-eval
    mainWindow.webContents.session.webRequest.onHeadersReceived((details, callback) => {
        callback({
            responseHeaders: Object.assign(Object.assign({}, details.responseHeaders), { 'Content-Security-Policy': [
                    "default-src 'self' 'unsafe-inline' data:; connect-src 'self' http://localhost:3001 ws://localhost:3001; script-src 'self' 'unsafe-eval';",
                ] }),
        });
    });
